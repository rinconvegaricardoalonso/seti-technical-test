...
class ProductServiceTest {
    ...
    void getTopProductsOfficeByFranchise_success() {
        when(productRepository.findTopStockByOffice(1))
    ...
    void createProduct_nameExists() {
        ProductDto dto = new ProductDto(null, "Product", 10, 1);

        when(productRepository.existsByName("PRODUCT")).thenReturn(Mono.just(true));
