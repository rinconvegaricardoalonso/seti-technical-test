 ...
 */
public interface OfficeRepository extends R2dbcRepository<OfficeEntity, Integer> {
     ...
     */
    Flux<OfficeEntity> findByFranchiseId(Integer franchiseId);
     ...
     */
    Mono<OfficeEntity> findByName(String name);
}
